        ...
        *,
        Row_number()
              OVER(
                ...
                ORDER BY dtmStampCreation desc) RowNum
    from edw.pfsedw.dbo.DimScoreCard
	where strScoreCardVersion in ('genxii', 'genxii_v2', 'genxii_v3', 'genxii_v4')
),
TblScore3 as 
(
select    
...
where tbltempstaticpool.dtmFunded >= '2024-06-28'
order by dtmFunded 