...
def parse_both_requests(cls_parse_payload, json_str_request_1, json_str_request_2):
	...
	# get X
	X_file1 = cls_parse_payload.dict_output['X_clean'].copy()
	...
	cls_parse_payload.shared_preprocessing()
	# get X
	X_file2 = cls_parse_payload.dict_output['X_clean'].copy()
...
def get_descriptions(df, str_local_path):
	...
	# get description
	dict_map = dict(zip(df_tmp['Feature Name'], df_tmp['Description']))
