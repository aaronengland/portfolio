...
class ParsePayload:
	# init
	def __init__(self, cls_model_preprocessing, cls_model_inference, dict_aa, str_tiers, list_cols_necessary, dict_bins_ltv):
		...
		self.dict_bins_ltv = dict_bins_ltv
	# get data
